  ...
  return (
    <div className="bg-[#fffef9] text-gray-600">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 place-content-center place-items-center gap-8">
            <div className="">
              <Link
                to="/"
                className="flex justify-start pb-5 items-center gap-3"
              >
                <div className="relative hover:-translate-y-1 hover:scale-110 duration-700 flex justify-center items-center gap-3">
                  <img src={logo} alt="" className="w-24" />
                  <div>
                    {" "}
                    <h5 className="text-2xl text-[#db241c] font-bold underline pb-2">
                      <span className="text-3xl ">Vibhuty  </span> Enterprises
                    </h5>
            ...
            <div className="">
              ...
              <p className="mb-4">
                <Link to="/OurProducts" className="text-gray-600">
                  Our Products
                </Link>
              </p>
            </div>
            ...
            <div className="">
              ...
              <p className="flex items-center justify-start mb-4">
                ...
                Vibhuty Enterprise,Kapodara, surat, 395006 <br />
                Gujarat,India
              </p>
              <p className="flex items-center justify-start mb-4">
                <svg
      ...
      <div className="text-center p-6 bg-gray-200">
        2018 © Vibhuty  Enterprises. All rights reserved.
      </div>
    </div>
  );
}
